...
const TopBar = (props) => {
  ...
  const handleorder = (url) => {
    setAnchorEl(null);
    history.push(url);
    // <Redirect to={{ pathname: "/dispatchedorder" }}></Redirect>;
    // // console.log(url);
  };
  return (
                ...
                <Grid container alignItems="center">
                  ...
                  <Grid item>
                    ...
                    <Menu
                      ...
                      onClose={handleClose}
                    >
                      <MenuItem onClick={() => handleorder("/vieworder")}>
                        Order Received
                      </MenuItem>
                      <MenuItem onClick={() => handleorder("/dispatchedorder")}>
                        Dispatched{" "}
                      </MenuItem>
                      <MenuItem
                        onClick={() => handleorder("/deliveryconfirmation")}
                      >
                        Delivered{" "}
                      </MenuItem>
