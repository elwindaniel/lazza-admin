...
import Form from "../../../common/forms/createState";
...
import { stateRequests } from "../../../../api/constants";
...
export default function StateTable() {
  ...
  const GetData = async () => {
    try {
      await Service.GetState().then((res) => {
        setLoading(true);
  ...
  const editData = (editId, editName, editCountryId) => {
    setOpen(true);
    setEdit(editId);
    setEditName(editName);
    setEditCountryId(editCountryId);
  };
                      ...
                      <TableCell>
                        ...
                        <IconButton aria-label="edit">
                          <MdEdit
                            ...
                            onClick={() =>
                              editData(item._id, item.stateName, item.countryId)
                            }
                          />
                        </IconButton>
                        {item.active == false ? (
